...
class QuizGenerator:
    ...
    def init_llm(self):
        ...
        """
        self.llm = VertexAI(
            model_name="gemini-pro",  # Step 1: Set the LLM's model name to "gemini-pro"
            temperature=0.7,  # Step 2: Configure the 'temperature' parameter
            max_output_tokens=400  # Step 3: Specify 'max_output_tokens'
        )
    ...
    def generate_question_with_vectorstore(self):
        ...
        Overview:
        This method leverages the vectorstore to retrieve relevant documents or context related to the quiz topic and uses the LLM to generate a quiz question in JSON format. The process involves retrieving documents, creating a prompt, and invoking the LLM to generate a question.
